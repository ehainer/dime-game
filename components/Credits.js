          ...
          {this.state.layout && <View style={{ height: Layout.height - this.state.layout.height }}>
            <ScrollView contentContainerStyle={{
              ...
              <View style={styles.section}>
                ...
                <View style={{ ...GlobalStyles.row, ...styles.iconRow }}>
                  <View style={styles.icon}>
                    <Svg width={20} height={30} viewBox="0 0 492 492">
                      <G>
                        <G>
                          <Path fill="white" d="M464.344,207.418l0.768,0.168H135.888l103.496-103.724c5.068-5.064,7.848-11.924,7.848-19.124
                            c0-7.2-2.78-14.012-7.848-19.088L223.28,49.538c-5.064-5.064-11.812-7.864-19.008-7.864c-7.2,0-13.952,2.78-19.016,7.844
                  ...
                  <View style={styles.attribution}>
                  <Text style={styles.text}>Icon made by <Text style={styles.link} onPress={() => this.onClickLink('https://www.flaticon.com/authors/roundicons')}>Roundicons</Text> from <Text style={styles.link} onPress={() => this.onClickLink('https://www.flaticon.com')}>Flat Icon</Text></Text>
                  </View>
                </View>
