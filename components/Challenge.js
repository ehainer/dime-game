...
class Challenge extends React.Component {
  ...
  getButtonColor(type) {
    return type === this.props.type ? 'lightseagreen' : 'white'
  }
  ...
  getAskIcon() {
    ...
    <G>
      <G>
        <G>
          <Path fill={this.getButtonColor('ASK')} strokeWidth="8" d="M448,309.333c-20.827,0-64,11.598-85.885,17.885c-2.904-30.609-42.125-41.444-82.656-49.677
          ...
          <Path fill={this.getButtonColor('ASK')} strokeWidth="8" d="M333.833,252.906c2.063,2.063,4.792,3.094,7.5,3.094c2.708,0,5.438-1.031,7.5-3.094l80.417-79.656
    ...
    return (
      <View style={{ flex: 1 }}>
        <View style={{ flex: 1 }}>
          ...
          <View style={{ flex: 1, marginBottom: PixelRatio.getPixelSizeForLayoutSize(20), alignItems: 'center', justifyContent: 'center' }}>
