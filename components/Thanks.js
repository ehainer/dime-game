  ...
  render() {
    return (
      <View style={{ flex: 1, overflow: 'hidden', alignItems: 'center', justifyContent: 'center' }}>
        <View style={{ flex: -1, alignItems: 'center', justifyContent: 'center', marginBottom: 40, maxWidth: Layout.maxWidth, minWidth: Layout.maxWidth }}>
          ...
          <View style={{ flex: -1, minWidth: Layout.minWidth, maxWidth: Layout.maxWidth }}>
